...
import { PrepositionInOnAtService } from "../services/preposition-in-on-at.service";

export class PrepositionInOnAtController {
  private service = new PrepositionInOnAtService();
